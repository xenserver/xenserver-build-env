...
case $GIT_BRANCH in
	...
	ely-bugfix)
		...
		;;
	falcon)
		XS_REPO_KEY=aHR0cDovL3hzLXl1bS1yZXBvcy5zMy13ZWJzaXRlLXVzLWVhc3QtMS5hbWF6b25hd3MuY29tL2ZhN2MwZWE5LTlkMzEtNTBiYi1hOGQ2LThhZTM2N2VmMmYxNC9kb21haW4w
		;;
	*)
		XS_REPO_KEY=aHR0cDovL3hzLXl1bS1yZXBvcy5zMy13ZWJzaXRlLXVzLWVhc3QtMS5hbWF6b25hd3MuY29tLzEzMzdhYjZjLTc3YWItOWM4Yy1hOTFmLTM4ZmJhOGJlZThkZC9kb21haW4w
		;;
esac
